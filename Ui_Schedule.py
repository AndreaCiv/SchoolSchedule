...
class Ui_Schedule(object):
    def setupUi(self, Schedule):
        ...
        Schedule.setWindowModality(QtCore.Qt.WindowModality.WindowModal)
        Schedule.resize(585, 297)
        ...
        Schedule.setMinimumSize(QtCore.QSize(585, 297))
        Schedule.setMaximumSize(QtCore.QSize(585, 297))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("padre-pio.jpg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"")
        ...
        self.calcola_orario.setMinimumSize(QtCore.QSize(70, 25))
        self.calcola_orario.setMaximumSize(QtCore.QSize(70, 25))
        self.calcola_orario.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.calcola_orario.setObjectName("calcola_orario")
        self.horizontalLayout.addWidget(self.calcola_orario)
        spacerItem5 = QtWidgets.QSpacerItem(55, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        ...
        spacerItem7 = QtWidgets.QSpacerItem(64, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        ...
        self.tableWidget.setMinimumSize(QtCore.QSize(431, 181))
        self.tableWidget.setMaximumSize(QtCore.QSize(431, 181))
...
"")
        ...
        spacerItem8 = QtWidgets.QSpacerItem(64, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.gridLayout.addItem(spacerItem8, 3, 5, 1, 1)
        spacerItem9 = QtWidgets.QSpacerItem(20, 31, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.gridLayout.addItem(spacerItem9, 4, 0, 3, 1)
        spacerItem10 = QtWidgets.QSpacerItem(20, 31, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.gridLayout.addItem(spacerItem10, 4, 1, 3, 1)
        spacerItem11 = QtWidgets.QSpacerItem(20, 1, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.gridLayout.addItem(spacerItem11, 4, 4, 1, 1)
        spacerItem12 = QtWidgets.QSpacerItem(300, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.gridLayout.addItem(spacerItem12, 5, 3, 1, 1)
        self.cambia_orario = QtWidgets.QPushButton(self.centralwidget)
        self.cambia_orario.setMinimumSize(QtCore.QSize(70, 25))
        self.cambia_orario.setMaximumSize(QtCore.QSize(70, 25))
        self.cambia_orario.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.cambia_orario.setObjectName("cambia_orario")
        self.gridLayout.addWidget(self.cambia_orario, 5, 4, 1, 1)
        spacerItem13 = QtWidgets.QSpacerItem(64, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
